...
const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <nav className="h-16 bg-white shadow flex items-center justify-between px-4 sticky top-0 z-20">
      <div className="flex items-center space-x-4">
        ...
        <button
          ...
          className="text-gray-600 p-2 hover:bg-gray-200 rounded md:hidden"
        >
          ☰
        </button>
        ...
        <button
          ...
          className="text-gray-600 p-2 hover:bg-gray-200 rounded hidden md:inline-block"
        >
          {sidebarOpen ? "☰" : "☰"}
        </button>
      </div>
